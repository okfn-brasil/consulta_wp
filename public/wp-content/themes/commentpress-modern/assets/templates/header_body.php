...
<div id="header">
	...
	?>
	<div id="page_title">
		<div id="title"><h1><a href="<?php echo home_url(); ?>" title="<?php _e( 'Home', 'commentpress-core' ); ?>"><img src="<?php echo get_template_directory_uri() . '/assets/images/logo.jpg';?>" alt="<?php bloginfo('title'); ?>" /></a></h1></div>
        <!--
